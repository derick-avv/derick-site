...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (leadForm) {
        leadForm.addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Thank you! Your information has been submitted. You will be notified as soon as the marketplace is live.');
            leadForm.reset();
        });
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (leadForm) {
        leadForm.addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Thank you! Your information has been received. You will be contacted once insurance advisory services resume.');
            leadForm.reset();
        });
    }
});
...
/**
 * Business Lending Form Handler
 * Derick Vasquez Portfolio
 */

document.addEventListener('DOMContentLoaded', () => {
    const leadForm = document.getElementById('lending-lead-form');
    if (leadForm) {
        leadForm.addEventListener('submit', (e) => {
            e.preventDefault();
            alert('Thank you! Your capital assessment request has been received. You will be connected with matching lending partners.');
            leadForm.reset();
        });
    }
});